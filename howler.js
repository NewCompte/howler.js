    ...
    play: function(sprite, callback) {
      ...
      self._inactiveNode(function(node) {
        ...
        if (self._webAudio) {
          ...
          if (node._offset > 0) {
            offset = self._sprite[sprite][0] / 1000 + offset;
          }
        } else {
          duration = self._sprite[sprite][1] / 1000 - (offset - self._sprite[sprite][0] / 1000);
        }
    ...
    offset: function(offset, id) {
      ...
      if (activeNode) {
        if (offset >= 0) {
          ...
          return self._webAudio ? activeNode._offset + (ctx.currentTime - self._playStart) : activeNode.currentTime;
        }
      } else if (offset >= 0) {
        return self;
      } else {
